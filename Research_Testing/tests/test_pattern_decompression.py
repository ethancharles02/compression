...
class TestPatternCompression(unittest.TestCase):
    ...
    def test_decompress_one_delimiter_area(self):
        self.decompressor.decompress("0110 000000 0110 001".replace(" ", ""))
    ...
    def test_decompressor_delimiter_setter_getter(self):
        ...
        self.assertEqual(self.decompressor._delimiter, "0110")
        self.assertEqual(self.decompressor._delimiter_replace_string, "0111")
        ...
        self.assertEqual(self.decompressor._delimiter_replace_string, "110")
        ...
        self.assertEqual(self.decompressor._delimiter_replace_string, "11000")

    def test_decompress_one_pattern(self):
        self.decompressor.decompress("0110 100100001000 0110 000".replace(" ", ""))
    ...
    def test_decompress_one_pattern_with_delimiter_patterns(self):
        self.decompressor.decompress("0110 1001110001000 0110 000".replace(" ", ""))
    ...
    def test_decompress_multiple_patterns(self):
        self.decompressor.decompress("0110 100100001000 0110 010".replace(" ", ""))
    ...
    def test_decompress_multiple_patterns_with_extra_bits_on_outside(self):
        self.decompressor.decompress("01010 0110 000100001001 0110 010 01010".replace(" ", ""))
    ...
    def test_decompress_pattern_longer_than_allocated_bits(self):
        ...
        self.decompressor.decompress("0110 100100001000 0110 11".replace(" ", ""))
        ...
        self.decompressor.decompress("0110 100100001000 0110 11 100100001000".replace(" ", ""))
    ...
    def test_decompress_string_inside_larger_decompressible_string(self):
        self.decompressor.decompress("0110 100100001000100100001000 0110 000".replace(" ", ""))
        self.assertEqual(self.decompressor.get_decompressed_data(), "100100001000 100100001000 100100001000 100100001000".replace(" ", ""))

    def test_decompress_string_inside_larger_decompressible_string_not_at_start(self):
        self.decompressor.decompress("01010 0110 000100001001000100001001 0110 000 01010".replace(" ", ""))
        self.assertEqual(self.decompressor.get_decompressed_data(), "01010 000100001001 000100001001 000100001001 000100001001 01010".replace(" ", ""))
    
    def test_decompress_multiple_different_patterns(self):
        self.decompressor.decompress("0110 000100001001 0110 001 0110 010001001001 0110 001".replace(" ", ""))
    ...
    def test_decompress_multiple_different_patterns_bits_separated(self):
        self.decompressor.decompress("0110 000100001001 0110 001 0000 0110 010001001001 0110 001".replace(" ", ""))
