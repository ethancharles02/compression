...
class TestPatternCompression(unittest.TestCase):
    ...
    def test_compress_adds_bits_to_one_existing_delimiter_strings(self):
        ...
        self.assertEqual(self.compressor.get_compressed_data(), "0111")

    def test_compress_adds_bits_to_multiple_existing_delimiter_strings(self):
        self.compressor.compress("011011011")
        self.assertEqual(self.compressor.get_compressed_data(), "011101110111")
    ...
    def test_compressor_delimiter_setter_getter(self):
        ...
        self.assertEqual(self.compressor._delimiter, "0110")
        self.assertEqual(self.compressor._delimiter_replace_string, "0111")
        ...
        self.assertEqual(self.compressor._delimiter_replace_string, "110")
        ...
        self.assertEqual(self.compressor._delimiter_replace_string, "11000")
    ...
    def test_compress_one_pattern(self):
        ...
        self.assertEqual(self.compressor.get_compressed_data(), "0110 100100001000 0110 000".replace(" ", ""))

    def test_compress_one_pattern_with_delimiter_patterns(self):
        self.compressor.compress("100110001000 100110001000".replace(" ", ""))
        self.assertEqual(self.compressor.get_compressed_data(), "0110 1001110001000 0110 000".replace(" ", ""))
    ...
    def test_compress_multiple_patterns(self):
        ...
        self.assertEqual(self.compressor.get_compressed_data(), "0110 100100001000 0110 010".replace(" ", ""))
    ...
    def test_compress_multiple_patterns_with_extra_bits_on_outside(self):
        ...
        self.assertEqual(self.compressor.get_compressed_data(), "01010 0110 000100001001 0110 010 01010".replace(" ", ""))
    ...
    def test_compress_pattern_longer_than_allocated_bits(self):
        ...
        self.assertEqual(self.compressor.get_compressed_data(), "0110 100100001000 0110 11".replace(" ", ""))

        self.compressor.compress("100100001000 100100001000 100100001000 100100001000 100100001000 100100001000".replace(" ", ""))
        self.assertEqual(self.compressor.get_compressed_data(), "0110 100100001000 0110 11 100100001000".replace(" ", ""))
    
    def test_compress_multiple_pieces_of_data(self):
        self.compressor.compress("100100001000 100100001000".replace(" ", ""))
        self.compressor.compress("100100001000 100100001000".replace(" ", ""))
        self.assertEqual(self.compressor.get_compressed_data(), "0110 100100001000 0110 000 0110 100100001000 0110 000".replace(" ", ""))
    ...
    def test_compressible_string_inside_larger_compressible_string(self):
        ...
        self.compressor.compress("100100001000 100100001000 100100001000 100100001000".replace(" ", ""))
        self.assertEqual(self.compressor.get_compressed_data(), "0110 100100001000100100001000 0110 000".replace(" ", ""))

    def test_compressible_string_inside_larger_compressible_string_not_at_start(self):
        self.compressor._max_look_ahead = 30
        self.compressor.compress("01010 000100001001 000100001001 000100001001 000100001001 01010".replace(" ", ""))
        self.assertEqual(self.compressor.get_compressed_data(), "01010 0110 000100001001000100001001 0110 000 01010".replace(" ", ""))
    ...
    def test_multiple_different_patterns(self):
        ...
        self.assertEqual(self.compressor.get_compressed_data(), "0110 000100001001 0110 001 0110 010001001001 0110 001".replace(" ", ""))
    ...
    def test_multiple_different_patterns_bits_separated(self):
        ...
        self.assertEqual(self.compressor.get_compressed_data(), "0110 000100001001 0110 001 0000 0110 010001001001 0110 001".replace(" ", ""))
    ...
    def test_delimiter_inbetween(self):
        ...
        self.assertEqual(self.compressor.get_compressed_data(), "0001000010 0111 00100001001".replace(" ", ""))
    ...
    def test_delimiter_inbetween_with_compression(self):
        ...
        self.assertEqual(self.compressor.get_compressed_data(), "0110 000100001001 0110 101 1110100001001".replace(" ", ""))

    # def test_num_patterns_create_raw_delimiter_after_pattern(self):
    #     self.compressor.compress("000100001010"*7 + "10")
    #     self.assertEqual(self.compressor.get_compressed_data(), "0110 000100001010 0110 101 110".replace(" ", ""))
    ...
    #     self.assertEqual(self.compressor.get_compressed_data(), "0110 000100001010 0110 101 01110".replace(" ", ""))
